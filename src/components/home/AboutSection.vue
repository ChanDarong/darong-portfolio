...
<template>
  <section class="section min-h-screen flex items-center justify-start px-6 sm:px-10 lg:px-30 relative">
    <div class="w-full flex">
      <div class="w-full">
        ...
        >
          <h1 class="uppercase text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">Who am I?</h1>
        </div>
        ...
        <div>
          <ul class="mt-5 space-y-3">
            ...
            >
              ...
              >
                <span class="bg-gray-700/10 dark:bg-green-700/25 border border-transparent dark:border-green-500 p-1 rounded">
                  <Icon :icon="item.icon" width="16" height="16" class="text-gray-600 dark:text-gray-300" />
                </span>
                <span>{{ item.text }}</span>
              </span>
            </li>
